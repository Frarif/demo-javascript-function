...
function runApp() {
  ...
  if (triangleBasePrompt && triangleHeightPrompt) {
    let areaResult = calculateTriangleArea(
      triangleBasePrompt,
      triangleHeightPrompt
    );
    let perimeterResult = calculateTrianglePerimeter(triangleBasePrompt);

    console.log(`Triangle area = ${areaResult} m²`);
    console.log(`Triangle perimeter = ${perimeterResult} m`);
  } else {
